...
public class TaskRepository {
    ...
    public static List<Task> getTasks(){
        ...
        taskRepository.add(new Task("Rejestracja zamówień", LocalDate.of(2019, 12, 1), LocalDate.of(2019, 12, 15)));
        taskRepository.add(new Task("Napisanie wiadomości e-mail do klientów", LocalDate.of(2019, 10, 22), LocalDate.of(2019, 10, 28)));
